...
class tokenizer{
  ...
  private function verifyCharacters(){
	...
	if($regexpresult == 0 || $regexpresult == false){
	  array_push($this->errorslist, $this->translator->translate('compile_character_error'));
	}
  }
  ...
  public function tokenize(){
	...
	if(count($this->tokenslist) == 0){
	  array_push($this->errorslist, $this->translator->translate('compile_no_token_error'));
	  return array();
	}
