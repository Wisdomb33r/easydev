...
* Last Modified..: $Date: 2008/01/14 16:28:48 $
...
*/
	function dynCalendar_show()
	{
        ...
        */
		...
		html += '<tr><td class="dynCalendar_header">' + prevLinkHTML + '</td><td colspan="5" align="center" class="dynCalendar_header"><nobr>' + monthCombo + ' ' + yearCombo + '</nobr></td><td align="right" class="dynCalendar_header">' + nextLinkHTML + '</td></tr>';
		html += '<tr>';
