...
%>
  ...
  echo <% echo $this->name; %>::getForm((isset($_GET['objectid']) ? $translator->translate('generator_modify_page_submit_button') : $translator->translate('generator_add_page_submit_button')), $object, $action);
